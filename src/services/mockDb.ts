...
export const INITIAL_JOBS: JobOpening[] = INITIAL_JOB_OPENINGS;

export const INITIAL_PAYROLL: PayrollRecord[] = INITIAL_EMPLOYEES.map(emp => ({
  id: `pay-${emp.id}`,
...
export const INITIAL_REVIEWS: PerformanceReview[] = [
  {
    ...
    feedback: 'Outstanding contributor to our microservices migration. Keep up the great work!',
  },
  {
    id: 'rev-2',
    organizationId: 'org-1',
    ...
    strengths: 'Spearheaded mobile redesign and greatly improved UI responsiveness.',
    areasOfImprovement: 'Expand unit test coverage across cross-platform flows.',
    feedback: 'Key driver of product usability.',
  },
];
